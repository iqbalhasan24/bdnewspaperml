          ...
          <div class="col-12" style="margin:0px; padding: 0px;">
              <nav class="multi-tab">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true" style="width: 50%;">সর্বশেষ সংবাদ</a>
                  <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false" style="width: 50%;">সর্বাধিক পঠিত</a>
...
<div class="row each-row">
      <?php get_lead_post_by_cat_with_cat_img(3 , 4, 'col-sm-4'); ?>
      <?php get_lead_post_by_cat_with_cat_img(3 , 4, 'col-sm-4'); ?>
      <?php get_lead_post_by_cat_with_cat_img(3 , 4, 'col-sm-4'); ?>
...
<div class="row each-row">
      ...
      <?php
       ...
       get_lead_post_by_cat_with_img_with_formate('aside', 3 , 6, 'col-sm-6','#fff'); 
       get_lead_post_by_cat_with_img_with_formate('aside', 3 , 3, 'col-sm-6','#fff'); 
