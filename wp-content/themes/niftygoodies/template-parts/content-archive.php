            ...
            <div class="container">
                ...
                <ul class="entry-meta">
                    <li>
                        ...
                        <span class="entry-author" itemscope="" itemtype="https://schema.org/Person"><span itemprop="author">
                    ...
                    <li>
                        ...
                        <span class="entry-date" itemscope="" itemtype="https://schema.org/Date"><span itemprop="date">
                        <time datetime="<?php the_time('l, F jS, Y') ?>" title="<?php the_time('F j, Y') ?>">
