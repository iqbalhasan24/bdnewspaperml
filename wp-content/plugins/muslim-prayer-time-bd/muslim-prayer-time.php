...
function mptb_admin_settings() {
	wp_register_script('mptbjs', plugins_url( 'js/mptb-admin.js', __FILE__ ), array('jquery'), '2.0');
	wp_enqueue_script('mptbjs');
	wp_enqueue_script('wp-color-picker');
	wp_enqueue_style('wp-color-picker');
	wp_enqueue_style('mptbadmin', plugins_url( 'css/mptb-admin.css', __FILE__ ), '', '2.0');
}
add_action('admin_init', 'mptb_admin_settings');

function mptb_enqueue_scripts(){
	wp_enqueue_style('prayer-time', plugins_url( 'css/prayer-time.css', __FILE__ ), '', '2.0');
}
...
function mptb_muslim_prayer_time() {
	...
	$pname_weight = get_option('pname_weight') != '' ? get_option('pname_weight') : 'normal';
...
<div class="muslim_prayer_time">
	<style type="text/css" media="all">
		...
		.muslim_prayer_time .prayer_name ul li.time_table {background-color: <?php echo $mptbg_one; ?>}
		.muslim_prayer_time .prayer_time ul li.time_table {background-color: <?php echo $mptbg_two; ?>}
		.muslim_prayer_time .prayer_name {font-weight: <?php echo $pname_weight; ?>;text-align: <?php echo $pname_align; ?>}
		.muslim_prayer_time .prayer_time {font-weight: <?php echo $ptime_weight; ?>;text-align: <?php echo $ptime_align; ?>}
		.muslim_prayer_time .prayer_name li.time_table {color: <?php echo $prayer_name; ?>}
		.muslim_prayer_time .prayer_time li.time_table {color: <?php echo $prayer_time; ?>}
		.muslim_prayer_time .sehri_time {background: <?php echo $sehri_bg; ?>;color: <?php echo $sehri_font; ?>;font-weight: <?php echo $sehri_weight; ?>;text-align: <?php echo $sehri_align; ?>}
	</style>
		...
		<form id="city_time" action="#prayerDis" method="post" name="city_time">
			<select id="cityname" name="cityname" onChange="prayerOnChange();">
				<option value="" selected="selected">
					<?php if(isset($_POST['cityname'])) { echo $_POST['cityname']; } else { echo $mptb_city; } ?>
				</option>
	...
	if(get_option('mptb_option') == 'Enabled') { ?>
	...
	<div class="prayer_name">
		<ul><?php
			for($t4b = 1; $t4b < 7; $t4b++) {
				if($t4b == 1) { echo '<li class="time_table row">ফজর</li>'; }
				if($t4b == 2) { echo '<li class="time_table altrow">যোহর</li>'; }
				if($t4b == 3) { echo '<li class="time_table row">আছর</li>'; }
				if($t4b == 4) { echo '<li class="time_table altrow">মাগরিব</li>'; }
				if($t4b == 5) { echo '<li class="time_table row">এশা</li>'; }
				if($t4b == 6) { echo '<li class="time_table altrow">সূর্যোদয়</li>'; }
			} ?>
		</ul>
	</div>
	<div class="prayer_time">
		<ul><?php
			for($t4b = 1; $t4b < 7; $t4b++) {
				if(isset($_POST['submit_city'])) {
					if($_POST['cityname'] == 'নেত্রকোনা' || $_POST['cityname'] == 'নরসিংদী' || $_POST['cityname'] == 'চাঁদপুর' || $_POST['cityname'] == 'ভোলা' || $_POST['cityname'] == 'কিশোরগঞ্জ') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '-1 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '-1 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '-1 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '-1 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '-1 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '-1 minutes')) . '</li>'; }
					} elseif($_POST['cityname'] == 'লক্ষ্মীপুর') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '-2 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '-2 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '-2 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '-2 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '-2 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '-2 minutes')) . '</li>'; }
					} elseif($_POST['cityname'] == 'ব্রাহ্মণবাড়িয়া' || $_POST['cityname'] == 'কুমিল্লা' || $_POST['cityname'] == 'নোয়াখালী') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '-3 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '-3 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '-3 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '-3 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '-3 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '-3 minutes')) . '</li>'; }
					} elseif($_POST['cityname'] == 'সুনামগঞ্জ' || $_POST['cityname'] == 'হবিগঞ্জ' || $_POST['cityname'] == 'ফেনী') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '-4 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '-4 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '-4 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '-4 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '-4 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '-4 minutes')) . '</li>'; }
					} elseif($_POST['cityname'] == 'মৌলভীবাজার' || $_POST['cityname'] == 'চট্টগ্রাম') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '-5 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '-5 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '-5 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '-5 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '-5 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '-5 minutes')) . '</li>'; }
					} elseif($_POST['cityname'] == 'সিলেট' || $_POST['cityname'] == 'খাগড়াছড়ি' || $_POST['cityname'] == 'কক্সবাজার') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '-6 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '-6 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '-6 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '-6 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '-6 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '-6 minutes')) . '</li>'; }
					} elseif($_POST['cityname'] == 'রাঙামাটি' || $_POST['cityname'] == 'বান্দরবান') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '-7 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '-7 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '-7 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '-7 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '-7 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '-7 minutes')) . '</li>'; }
					} elseif($_POST['cityname'] == 'মাদারীপুর' || $_POST['cityname'] == 'ঝালকাঠি' || $_POST['cityname'] == 'বরগুনা') {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '+1 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '+1 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '+1 minutes')) . '</li>'; }
						...
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], '+8 minutes')) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], '+8 minutes')) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], '+8 minutes')) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], '+8 minutes')) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], '+8 minutes')) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], '+8 minutes')) . '</li>'; }
					} else {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time($time_schedule['fajr']) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time($time_schedule['duhr']) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time($time_schedule['asr']) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time($time_schedule['maghrib']) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time($time_schedule['isha']) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time($time_schedule['sunrise']) . '</li>'; }
					}
				} else {
					if($adjust_time != ''){
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['fajr'], $adjust_time)) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time(prayer_district_time($time_schedule['duhr'], $adjust_time)) . '</li>'; }
						if($t4b == 3) { echo '<li class="time_table row">বিকাল ' . bn_prayer_time(prayer_district_time($time_schedule['asr'], $adjust_time)) . '</li>'; }
						if($t4b == 4) { echo '<li class="time_table altrow">সন্ধ্যা ' . bn_prayer_time(prayer_district_time($time_schedule['maghrib'], $adjust_time)) . '</li>'; }
						if($t4b == 5) { echo '<li class="time_table row">রাত ' . bn_prayer_time(prayer_district_time($time_schedule['isha'], $adjust_time)) . '</li>'; }
						if($t4b == 6) { echo '<li class="time_table altrow">ভোর ' . bn_prayer_time(prayer_district_time($time_schedule['sunrise'], $adjust_time)) . '</li>'; }
					}
					else {
						if($t4b == 1) { echo '<li class="time_table row">ভোর ' . bn_prayer_time($time_schedule['fajr']) . '</li>'; }
						if($t4b == 2) { echo '<li class="time_table altrow">দুপুর ' . bn_prayer_time($time_schedule['duhr']) . '</li>'; }
...
function widget_muslim_prayer_time($args) {
	extract($args);
	echo $before_widget;
		echo $before_title . __('Prayer Time Table', 'mptb') . $after_title;
		echo do_shortcode('[prayer_time]');
	echo $after_widget;
}
if(is_admin())
